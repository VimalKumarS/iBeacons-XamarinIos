...
void xamarin_create_classes () {
	...
	__xamarin_class_map [5].handle = objc_getClass ("NSError");
	__xamarin_class_map [6].handle = objc_getClass ("NSException");
	...
	__xamarin_class_map [27].handle = objc_getClass ("CLVisit");
	...
	__xamarin_class_map [42].handle = objc_getClass ("CoreLocation_CLLocationManager__CLLocationManagerDelegate");
